...
class EditProfile extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.profile.profile !== this.props.profile.profile) {
            ...
            // initialize variable to either open or close social media options
            let showOptions;

            // Destructure items of object, if they don't exist make them an empty string
            const { 
                company = '', 
                website = '', 
                location = '',
            ...
            this.setState({
                ...
                linkedin,
                skills: skillsCSV,
                displaySocialInputs: showOptions ? true : false
            });
        }
    }
    componentDidMount() {
